...
import bakalarskyprojekt.db.H2DatabaseConnector;
...
public class DatabaseViewController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        userLabel.setText(Info.DB_DEFAULT_USERNAME);
        passLabel.setText(Info.DB_DEFAULT_PASSWORD);
        dirLabel.setText(H2DatabaseConnector.DB_DIR);
    ...
    private static class H2DatabaseConnectorImpl extends H2DatabaseConnector {
        ...
        DatabaseViewController dpcontroller;
        ...
        public H2DatabaseConnectorImpl(DatabaseViewController dpcontroller) {
        ...
        public void execute(String query) {
            ...
            new Thread(() -> {//TODO maybe execute this with bakalprojekt.runlater since it can be used here 
